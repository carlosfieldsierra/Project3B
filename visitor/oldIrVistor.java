...
public class IRVistor implements Visitor {
    ...
    */
    ...
    /* 
        Method to label HashMap
    */
    private HashMap<String,String> methodToLabelMap = new HashMap<>();
    /* 
    ...
    public void visit(MainClass n){
        ...
        */
        ...
        /* 
            Add to method label
        */
        String label = addLabel(IR.get(0), new Label(true));
        methodToLabelMap.put(
            "main",
             label
        );
    ...
    */
    public void visit(MethodDecl n){
        ...
        */
        ...
        /*  
            Add label to methodLabelMap
        */
        String label = addLabel(IR.get(indexBeforeMethod), new Label(true));
		methodToLabelMap.put(n.i.toString(), label);
        /* 
            Exit Scope
        */
        currScope = currScope.exitScope();
